...
def test_template_supports_quoted_and_boolean_values(
    tmp_path: Path,
):
    ...
    # enabled is not part of TemplateDefinition,
    # so this test only verifies that the Markdown
    # metadata parser can read common scalar values.
    from beivymate.configuration.loader import (
        _read_markdown,
    )
