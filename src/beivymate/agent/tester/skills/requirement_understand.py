...
class RequirementUnderstandSkill(Skill):
    ...
    def execute(
        ...
        prompt = self._build_prompt(
            ...
            requirement_data,
            knowledge,
            (context.get("analysis_strategy") or "standard"),
            context.get_locale(),
        )
        if selection is not None and selection.deferred:
        ...
        metadata = dict(
            task_id=context.get("task_id"), run_id=context.get("run_id"),
            step_id=context.get("step_id", "requirement_understand"),
        ...
        context.set("requirement_understand_artifact", artifact)
